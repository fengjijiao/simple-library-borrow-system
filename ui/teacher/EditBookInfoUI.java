...
public class EditBookInfoUI extends JFrame implements ActionListener {
    ...
    public EditBookInfoUI(int bid) {
        ...
        jt.setText((String) hashMap.get("name"));
        jp.add(jt);
        jl1 = new JLabel("ISBN");
        ...
        jt1.setText((String) hashMap.get("isbn"));
        ...
        jt2.setText((String) hashMap.get("author"));
        jp.add(jt2);
        jl3 = new JLabel("出版者");
        ...
        jt3.setText((String) hashMap.get("publisher"));
        jp.add(jt3);
        ...
        jt4.setText((String) hashMap.get("publicationdate"));
        jp.add(jt4);
        jl5 = new JLabel("库存");
        ...
        jt5.setText(String.valueOf(hashMap.get("stock")));
        jp.add(jt5);
        jb = new JButton("保存");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand().equals("保存")) {
            ...
            if(name.equals("")) {
                ...
                DBOP.updateBook(bid,isbn,name,author,publisher,publicationdate,stock);
